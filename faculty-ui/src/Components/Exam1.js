      ...
      <div className="exam">
        <div className="flex jc-between ai-start">
          ...
          <aside>
            ...
            <div className="absolute a-1">
              <img src="media/warning message.png" alt="warning message" />
            </div>
            <div className="absolute a-2">
              <img src="media/red warning.png" alt="warning red" />
            </div>
            <div className="absolute a-3">
              <img src="media/yellow warning.png" alt="warning yellow" />
            </div>
          </aside>
        </div>
      </div>
